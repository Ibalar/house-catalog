# Laravel 11 + MoonShine 4 - Веб-каталог строительной организации

Этот проект представляет собой базовую установку Laravel 11 с MoonShine 4 админ-панелью и системой аутентификации для создания веб-каталога строительной организации.
